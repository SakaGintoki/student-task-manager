...
<div class="max-w-3xl mx-auto">
    <div class="flex justify-between items-center mb-8">
        <h2 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Tambah Tugas Baru</h2>
        ...
        <div class="p-8 md:p-10">
            <form action="{{ route('tasks.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl text-slate-900 dark:text-white placeholder-slate-400 focus:ring-2 focus:ring-primary-500 transition-all font-medium" value="{{ old('title') }}" placeholder="Masukkan judul tugas" required>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="deadline" id="deadline" class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl text-slate-900 dark:text-white focus:ring-2 focus:ring-primary-500 transition-all font-medium" value="{{ old('deadline') }}" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="5" class="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800 border-none rounded-2xl text-slate-900 dark:text-white placeholder-slate-400 focus:ring-2 focus:ring-primary-500 transition-all font-medium" placeholder="Tambahkan detail tugas jika diperlukan...">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full py-5 bg-primary-600 hover:bg-primary-700 text-white font-black rounded-2xl shadow-xl shadow-primary-600/20 transition-all hover:-translate-y-1 flex items-center justify-center text-lg">
                        <i class="fa-solid fa-save mr-3"></i> Simpan Tugas
                    </button>
                </div>
            </form>
        </div>
